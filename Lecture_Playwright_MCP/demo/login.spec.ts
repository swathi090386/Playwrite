...
test.describe('VWO Login Page Tests', () => {
  ...
  test('TC_LOGIN_001: Login page elements should be displayed', async ({ page }) => {
    // Verify all UI elements are visible
    await expect(page.locator('img[alt*="VWO"], img[src*="vwo"]')).toBeVisible();
  ...
  test('TC_LOGIN_003: Invalid email format should show error', async ({ page }) => {
  ...
  test('TC_LOGIN_005: Empty email should show validation error', async ({ page }) => {
    const passwordInput = page.locator('input[type="password"]');
    const signInButton = page.locator('button:has-text("Sign in")');
  ...
  test('TC_LOGIN_006: Empty password should show validation error', async ({ page }) => {
    const emailInput = page.locator('input[placeholder*="email" i]');
    const signInButton = page.locator('button:has-text("Sign in")');
    ...
    // Check for validation error
    await expect(page.locator('text=/required|password/i')).toBeVisible({ timeout: 5000 });
  });

  // TC_LOGIN_007: Show/Hide password functionality
  test('TC_LOGIN_007: Password visibility toggle should work', async ({ page }) => {
    const passwordInput = page.locator('input[type="password"]');
  ...
  test('TC_LOGIN_008: Remember me checkbox should be toggleable', async ({ page }) => {
  ...
  test('TC_LOGIN_009: Forgot Password link should navigate to reset page', async ({ page }) => {
  ...
  test('TC_LOGIN_010: Google sign-in button should be clickable', async ({ page, context }) => {
  ...
  test('TC_LOGIN_011: SSO button should be clickable', async ({ page }) => {
  ...
  test('TC_LOGIN_012: Passkey button should be clickable', async ({ page }) => {
  ...
  test('TC_LOGIN_013: Start FREE TRIAL button should navigate to signup', async ({ page }) => {
  ...
  test('TC_LOGIN_014: SQL injection should be prevented', async ({ page }) => {
    const emailInput = page.locator('input[placeholder*="email" i]');
    const passwordInput = page.locator('input[type="password"]');
    const signInButton = page.locator('button:has-text("Sign in")');
  ...
  test('TC_LOGIN_015: XSS injection should be prevented', async ({ page }) => {
    const emailInput = page.locator('input[placeholder*="email" i]');
  ...
  test('TC_LOGIN_016: Login page should be responsive on mobile', async ({ page }) => {
    // Set mobile viewport
  ...
  test('TC_LOGIN_017: Tab navigation should follow logical order', async ({ page }) => {
    const emailInput = page.locator('input[placeholder*="email" i]');
  ...
  test('TC_LOGIN_023: Email with spaces should be trimmed', async ({ page }) => {
    const emailInput = page.locator('input[placeholder*="email" i]');
    const passwordInput = page.locator('input[type="password"]');
    const signInButton = page.locator('button:has-text("Sign in")');
  ...
  test('TC_LOGIN_024: Login page should use HTTPS', async ({ page }) => {
    const url = page.url();
